    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<GroupProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut insights_configuration: Option<crate::Value<self::group::InsightsConfiguration>> = None;
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<SamplingRuleProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut sampling_rule_record: Option<crate::Value<self::sampling_rule::SamplingRuleRecord>> = None;
                let mut sampling_rule_update: Option<crate::Value<self::sampling_rule::SamplingRuleUpdate>> = None;
                let mut tags: Option<crate::ValueList<crate::json::Value>> = None;
