...
impl<'de> ::serde::Deserialize<'de> for DataflowEndpointGroupProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<DataflowEndpointGroupProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut endpoint_details: Option<crate::ValueList<self::dataflow_endpoint_group::EndpointDetails>> = None;
                let mut tags: Option<crate::ValueList<crate::Tag>> = None;
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<MissionProfileProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut dataflow_edges: Option<crate::ValueList<self::mission_profile::DataflowEdge>> = None;
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<ConfigData, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    ...
                    let mut antenna_downlink_demod_decode_config: Option<crate::Value<AntennaDownlinkDemodDecodeConfig>> = None;
                    let mut antenna_uplink_config: Option<crate::Value<AntennaUplinkConfig>> = None;
                    let mut dataflow_endpoint_config: Option<crate::Value<DataflowEndpointConfig>> = None;
