...
pub struct CloudFormationProductProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub provisioning_artifact_parameters: crate::ValueList<self::cloud_formation_product::ProvisioningArtifactProperties>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<CloudFormationProductProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut provisioning_artifact_parameters: Option<crate::ValueList<self::cloud_formation_product::ProvisioningArtifactProperties>> = None;
...
pub struct CloudFormationProvisionedProductProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub provisioning_parameters: Option<crate::ValueList<self::cloud_formation_provisioned_product::ProvisioningParameter>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub provisioning_preferences: Option<crate::Value<self::cloud_formation_provisioned_product::ProvisioningPreferences>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<CloudFormationProvisionedProductProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut provisioning_parameters: Option<crate::ValueList<self::cloud_formation_provisioned_product::ProvisioningParameter>> = None;
                let mut provisioning_preferences: Option<crate::Value<self::cloud_formation_provisioned_product::ProvisioningPreferences>> = None;
                let mut tags: Option<crate::ValueList<crate::Tag>> = None;
...
impl<'de> ::serde::Deserialize<'de> for ServiceActionProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ServiceActionProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut accept_language: Option<crate::Value<String>> = None;
                let mut definition: Option<crate::ValueList<self::service_action::DefinitionParameter>> = None;
