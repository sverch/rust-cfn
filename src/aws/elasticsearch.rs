    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<DomainProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut advanced_security_options: Option<crate::Value<self::domain::AdvancedSecurityOptionsInput>> = None;
                let mut cognito_options: Option<crate::Value<self::domain::CognitoOptions>> = None;
                let mut domain_endpoint_options: Option<crate::Value<self::domain::DomainEndpointOptions>> = None;
                let mut domain_name: Option<crate::Value<String>> = None;
                let mut ebs_options: Option<crate::Value<self::domain::EBSOptions>> = None;
                let mut elasticsearch_cluster_config: Option<crate::Value<self::domain::ElasticsearchClusterConfig>> = None;
                let mut elasticsearch_version: Option<crate::Value<String>> = None;
                let mut encryption_at_rest_options: Option<crate::Value<self::domain::EncryptionAtRestOptions>> = None;
                let mut log_publishing_options: Option<crate::ValueMap<self::domain::LogPublishingOption>> = None;
                let mut node_to_node_encryption_options: Option<crate::Value<self::domain::NodeToNodeEncryptionOptions>> = None;
