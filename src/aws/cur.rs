...
pub struct ReportDefinitionProperties {
    ...
    pub additional_artifacts: Option<crate::ValueList<String>>,
    ...
    pub additional_schema_elements: Option<crate::ValueList<String>>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub billing_view_arn: Option<crate::Value<String>>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub compression: crate::Value<String>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub refresh_closed_reports: crate::Value<bool>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub report_name: crate::Value<String>,
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub report_versioning: crate::Value<String>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub s3_prefix: crate::Value<String>,
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub s3_region: crate::Value<String>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ReportDefinitionProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut additional_artifacts: Option<crate::ValueList<String>> = None;
                let mut additional_schema_elements: Option<crate::ValueList<String>> = None;
                let mut billing_view_arn: Option<crate::Value<String>> = None;
                let mut compression: Option<crate::Value<String>> = None;
                let mut format: Option<crate::Value<String>> = None;
                let mut refresh_closed_reports: Option<crate::Value<bool>> = None;
                let mut report_name: Option<crate::Value<String>> = None;
                let mut report_versioning: Option<crate::Value<String>> = None;
                let mut s3_bucket: Option<crate::Value<String>> = None;
                let mut s3_prefix: Option<crate::Value<String>> = None;
                let mut s3_region: Option<crate::Value<String>> = None;
...
impl crate::Resource for ReportDefinition {
