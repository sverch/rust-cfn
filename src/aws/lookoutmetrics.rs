...
pub struct AlertProperties {
    ...
    pub action: crate::Value<crate::json::Value>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<AlertProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut action: Option<crate::Value<crate::json::Value>> = None;
...
pub struct AnomalyDetectorProperties {
    ...
    pub anomaly_detector_config: crate::Value<crate::json::Value>,
...
impl<'de> ::serde::Deserialize<'de> for AnomalyDetectorProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<AnomalyDetectorProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut anomaly_detector_config: Option<crate::Value<crate::json::Value>> = None;
                ...
                let mut metric_set_list: Option<crate::ValueList<self::anomaly_detector::MetricSet>> = None;
